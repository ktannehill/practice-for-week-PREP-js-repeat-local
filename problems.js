...
function isSubString(searchString, subString) {
    ...
    /* The return value of .indexOf is a number value
    -1 is the return value that indicates a substring is not located in a string
    -1 is still a number, thus returning true even when we want it to return false
    need to state that we DO NOT want the indexOf to = -1 */
